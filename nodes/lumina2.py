# Copied directly from https://github.com/comfyanonymous/ComfyUI/pull/6795 and altered to not have name collisions with the PR.
# Will be removed once that PR is merged.
